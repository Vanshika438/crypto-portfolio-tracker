...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 px-4 relative overflow-hidden">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-indigo-600 opacity-20 blur-3xl rounded-full"></div>
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-violet-600 opacity-20 blur-3xl rounded-full"></div>
      ...
      <div className="relative w-full max-w-md bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 rounded-3xl shadow-2xl border border-slate-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-600 hover:to-violet-600 text-white font-semibold transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-indigo-500/20"
          >
